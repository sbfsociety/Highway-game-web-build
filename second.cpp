...
public:
    ...
    void Draw(sf::RenderWindow& window, sf::Sprite& obs, int frameCount, Player& player) {
        ...
        if (frameCount % 30 == 0) {
            obs.setTextureRect(sf::IntRect({((animationIndex%2) * 64), 0 }, {64, 64}));
        }
...
int main() {
    ...
    if (!obstacleTexture.loadFromFile("../assets/blob.png")) {
        (void)obstacleTexture.loadFromFile("/assets/blob.png");
    }
    ...
    sf::Font font;
    if (!font.openFromFile("../assets/flappy.ttf")) {
        (void)font.openFromFile("/assets/flappy.ttf");
    ...
    if (!splatB.loadFromFile("../assets/splatC.mp3")) {
        (void)splatB.loadFromFile("assets/splatC.mp3");
    }
    //std::cerr << "Error loading splatC.mp3" << std::endl;
    if (!runB.loadFromFile("../assets/run.mp3")) {
        (void)runB.loadFromFile("assets/run.mp3");
    }
        //std::cerr << "Error loading run.mp3" << std::endl;
    if (!carB.loadFromFile("../assets/carCCC.mp3")) {
        (void)carB.loadFromFile("assets/carCCC.mp3");
    }
        //std::cerr << "Error loading carC.mp3" << std::endl;
    if (!melonB.loadFromFile("../assets/melon.mp3")) {
        (void)melonB.loadFromFile("assets/melon.mp3");
    }
        //std::cerr << "Error loading melon.mp3" << std::endl;
    ...
    sf::Music soundtrack;
    if (!soundtrack.openFromFile("../assets/soundtrack.mp3")) {
        (void)soundtrack.openFromFile("assets/soundtrack.mp3");
    }
        //std::cerr << "Error loading soundtrack.ogg" << std::endl;
    ...
    if (!backgroundTexture.loadFromFile("../assets/popravka.png")) {
        (void)backgroundTexture.loadFromFile("assets/popravka.png");
    }
    sf::Sprite background(backgroundTexture);
    background.setPosition({100, 100});
    background.setScale({1.f, 1.f});

    if (!travaT.loadFromFile("../assets/trava.png")) {
        (void)travaT.loadFromFile("assets/trava.png");
    }
    if (!putT.loadFromFile("../assets/ulica.png")) {
        (void)putT.loadFromFile("assets/ulica.png");
    }
    ...
    if (!carTexture.loadFromFile("../assets/car.png")) {
        (void)carTexture.loadFromFile("assets/car.png");
    }
    ...
    if (!playerTexture.loadFromFile("../assets/darthMalls.png")) {
        (void)playerTexture.loadFromFile("assets/darthMalls.png");
    }
